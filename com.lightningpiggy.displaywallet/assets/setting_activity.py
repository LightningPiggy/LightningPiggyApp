...
class SettingActivity(Activity):
    ...
    def onCreate(self):
        ...
        if ui and ui == "radiobuttons" and ui_options:
            ...
            self.textarea.set_style_pad_all(mpos.ui.pct_of_display_width(2), 0)
            self.textarea.set_style_margin_left(mpos.ui.pct_of_display_width(2), 0)
            self.textarea.set_style_margin_right(mpos.ui.pct_of_display_width(2), 0)
